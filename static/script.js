...
const OPENAI_API_KEY = "openai.api_key"; // Your OpenAI API key here
...
const generateAiImages = async (userPrompt, userImgQuantity) => {
	try {
		...
		const {
			data
		} = await response.json(); // Get data from the response
...
const handleImageGeneration = (e) => {
    ...
    <div class="img-card loading">
        <img src="${document.body.getAttribute('data-loader-url')}" alt="AI generated image">
        <a class="download-btn" href="#">
            <img src="${document.body.getAttribute('data-download-url')}" alt="download icon">
        </a>
    </div>`).join("");
